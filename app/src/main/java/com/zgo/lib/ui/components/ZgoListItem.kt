...
fun ListItem(
    ...
    val styledSecondaryText =
        applyTextStyle(typography.bodyMedium, ContentAlpha.medium, secondaryText)
    val styledOverlineText = applyTextStyle(
        typography.labelSmall.copy(letterSpacing = 1.5.sp),
        ContentAlpha.high,
        overlineText
    )
...
//    private val ContentLeftPadding = 16.dp
    private val ContentLeftPadding = 0.dp
